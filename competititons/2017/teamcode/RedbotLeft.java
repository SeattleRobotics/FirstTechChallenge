...
@Autonomous(name="Redbot Left Arm")

public class RedbotLeft extends OpMode {
    ...
    if (color == "blue") {
        wheels.moveBot(this, "forward", .25);
        armL.moveJewelArmAuto(this, "left", "up");
        wheels.moveBot(this, "forward", 1.5);
    
    } else {
        wheels.moveBot(this, "backward", .25);
        armL.moveJewelArmAuto(this, "left", "up");
